...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		pD3DDevice->Clear(1, (D3DRECT*)&r, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, 255, 1.0, 0);
...
void DrawScene()
{
    ...
    pEffect->SetValue("view_proj_matrix", &Full, D3DX_DEFAULT);
    pEffect->SetValue("ViewAngle", &ViewAngle, D3DX_DEFAULT);
    pEffect->SetValue("color", new D3DXVECTOR4(0, 0, 1, 1), D3DX_DEFAULT);
