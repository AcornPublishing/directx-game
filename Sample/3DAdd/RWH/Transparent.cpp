...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   Triangle[3].color = D3DCOLOR_XRGB(100, 100, 100);
   Triangle[4].color = D3DCOLOR_XRGB(100, 100, 100);
   Triangle[5].color = D3DCOLOR_XRGB(100, 100, 100);
   Triangle[6].color = D3DCOLOR_XRGB(100, 100, 100);
   ...
   if (FAILED(pD3DDevice->CreateVertexBuffer(sizeof(sVertex) * 7,
	   D3DUSAGE_WRITEONLY, D3DFVF_XYZRHW | D3DFVF_DIFFUSE, D3DPOOL_DEFAULT, &vTriangleBuffer, 0)))
	   return FALSE;
