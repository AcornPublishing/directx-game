...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   D3DXCreateTextureFromFileEx(pD3DDevice, "tex.bmp", 256, 256, 0, 0, D3DFMT_A8R8G8B8, D3DPOOL_MANAGED, D3DX_DEFAULT, D3DX_DEFAULT,	0, 0, 0, &tQuadTexture);
...
void DrawScene()
{
  ...
  pD3DDevice->SetFVF(D3DFVF_XYZ | D3DFVF_TEX1);
   ...
   for (int i=0; i<256; i++)
	   for (int j=0; j<256; j++)
	   {
		   if (*(DWORD *)(dst+i*text_rect.Pitch+j*4)!=0x00FF00FF)
               *(DWORD *)(dst+i*text_rect.Pitch+j*4)+=0x01000000;
	   }
