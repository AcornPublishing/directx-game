...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   Triangle[1].y=-0.2f;
   Triangle[1].z=0.1f;
   Triangle[1].color = D3DCOLOR_XRGB(0, 0, 255);

   Triangle[2].x=-0.2f;
   Triangle[2].y=-0.4f;
   Triangle[2].z=0.1f;
   Triangle[2].color = D3DCOLOR_XRGB(0, 0, 255);

   Triangle[3].x=-0.2f;
   Triangle[3].y=-0.2f;
   Triangle[3].z=0.1f;
   Triangle[3].color = D3DCOLOR_XRGB(0, 0, 255);

   Triangle[4].x=-0.4f;
   Triangle[4].y=-0.4f;
   Triangle[4].z=0.1f;
   Triangle[4].color = D3DCOLOR_XRGB(0, 0, 255);

   Triangle[5].x=-0.4f;
   Triangle[5].y=0.4f;
   Triangle[5].z=0.1f;
   Triangle[5].color = D3DCOLOR_XRGB(0, 0, 255);

   Triangle[6].x=0.4f;
   Triangle[6].y=-0.4f;
   Triangle[6].z=0.1f;
   Triangle[6].color = D3DCOLOR_XRGB(0, 0, 255);

   Triangle[7].x=0.4f;
   Triangle[7].y=0.4f;
   Triangle[7].z=0.1f;
   Triangle[7].color = D3DCOLOR_XRGB(0, 0, 255);

   void * pBuf;
   if (FAILED(pD3DDevice->CreateVertexBuffer(sizeof(sVertex) * 8,
	   D3DUSAGE_WRITEONLY, D3DFVF_XYZ | D3DFVF_DIFFUSE, D3DPOOL_DEFAULT, &vTriangleBuffer, 0)))
	   return FALSE;

  // 정점 버퍼 복사
   if (FAILED(vTriangleBuffer->Lock(0, sizeof(sVertex) * 8, &pBuf, 0)))
	   return FALSE;
   memcpy(pBuf, Triangle, sizeof(sVertex) * 8);
