// buffer.cpp : Defines the entry point for the application.
//
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_BUFFER, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_BUFFER);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, (LPCTSTR)IDI_BUFFER);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   desc.lpSurface = &video_buf;
   desc.lPitch  = iWidth * 2;
   ppiDD->CreateSurface(&desc, &buf_surface, 0);
