...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   imagesurf2 = LoadBMPToSurface("trans.bmp", ppiDD);
...
//			backsurf->BltFast(0, 0, imagesurf, NULL, DDBLTFAST_WAIT);
			...
			// 다음 이미지 서피스를 표시하기 위한 구조체 설정
			dst.left=dst.top=200;
			dst.right=300;
			dst.bottom=265;

			backsurf->Blt(&dst, imagesurf2, 0, DDBLT_WAIT, &bltfx);
